...
public class Dec3Service {
    ...
    public static void main(String[] args) {
        ...
        fileNames.add("D:\\temp\\云硬盘卸载10");
        fileNames.add("D:\\temp\\云硬盘卸载30");
        fileNames.add("D:\\temp\\云硬盘卸载50");
        fileNames.add("D:\\temp\\云硬盘卸载80");
        fileNames.add("D:\\temp\\云硬盘卸载100");
            ...
            try {
                ...
                while ((str = bf.readLine()) != null) {
                    ...
                    if (a > 0) {
                        ...
                        if (str.contains("#VolumeController.unmount 硬盘卸载") && reqIds.contains(reqId)
